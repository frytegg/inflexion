...
| **▶ NEXT**       | Task **14.7** — parameter calibration (`c_min`, fee curve, exposure caps, fund target balance) → emits to `quant/params.json` (Task 14.8)                                                                                                                                       |
| **Spec version** | v3.3 build-ready                                                                                                                                                                                                                                                                |
| **Last commit**  | `feat(quant): Task 14.6 - stress scenarios (correlated crash + vol shift + utilization spike, 19 tests, notebook 05)`                                                                                                                                                           |
| **Repo**         | https://github.com/frytegg/inflexion (private)                                                                                                                                                                                                                                  |
| **Quant track**  | 14.1–14.6 done (76 tests green); next 14.7 (calibration) → 14.8 (`params.json`)                                                                                                                                                                                                 |
| **Last update**  | 2026-05-27 — Task 14.6 stress scenarios landed                                                                                                                                                                                                                                  |
