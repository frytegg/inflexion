...
| **▶ NEXT**       | Task **14.8** — emit calibrated `CalibrationResult` to versioned `quant/params.json` + schema + roundtrip test                                                                                                                                                                  |
| **Spec version** | v3.3 build-ready                                                                                                                                                                                                                                                                |
| **Last commit**  | `feat(quant): Task 14.7 - PARTIAL parameter calibration (17 tests, notebook 06)`                                                                                                                                                                                                |
| **Repo**         | https://github.com/frytegg/inflexion (private)                                                                                                                                                                                                                                  |
| **Quant track**  | 14.1–14.7 done (93 tests green); next 14.8 (`params.json`) → 14.9 (deck charts)                                                                                                                                                                                                 |
| **Last update**  | 2026-05-27 — Task 14.7 calibration landed                                                                                                                                                                                                                                       |
