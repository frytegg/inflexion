...
| **▶ NEXT**       | **P2.2 — `FairValueOracle` (exact Φ-sum)** (Stylus side needs WSL2; Solidity-first with bounded-Φ error + Python equivalence). **P2.1 — `VolOracle.sol` (σ-EWMA) is DONE** (committed `e6f1555` on branch `p2-fairvalue-vol-oracle`; 6 tests green; solady vendored for `lnWad`/`expWad`). **P1.13 changed the launch plan:** the bare single-tranche pool is NOT a safe depositor product, so **senior/junior tranching is PROMOTED into launch (P3.1 + new P3.1b), no longer stretch** — build the tranched ConvexityVault directly (no bare-vault rework). _(Task 5.14 Sepolia deploy stays paused → P3.x.)_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| **Last commit**  | `feat(quant): heavy single-asset calibration run — final cvAMM params + real depositor disclosure numbers` (P1.14)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| **Last update**  | 2026-06-02 — **P1 complete + P2.1 done + launch-plan change.** P1.13 heavy run proved the bare untranched pool is not a safe depositor product → **senior/junior tranching promoted from stretch (15.8) into LAUNCH scope (P3.1 + P3.1b)**; the tranched ConvexityVault is built directly (no bare-vault rework). Depositor disclosure numbers replaced with the REAL single-asset figures (geometric CAGR). Risk-register entry added (bare-pool-as-product RESOLVED). **ROADMAP now leads the spec on tranching-in-launch — P5.1/P5.2 must fold it into spec §8/§14/§18 (move from roadmap to launch).** P2.1 VolOracle committed (`e6f1555`). Settle/MaxIL/I1–I9 untouched; `params.json`/`params.py` unchanged.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
