...
|                  |                                                                                                                                                                                                                                                                                 |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Phase**        | 14 — Quant (complete + audit-fixed v2.0.0) · Phase 2 deferred to home PC                                                                                                                                                                                                        |
| **▶ NEXT**       | Task **2.2** (home PC, WSL2) — Rust fixed-point primitives for ILMath Stylus contract                                                                                                                                                                                           |
| **Spec version** | v3.3 build-ready                                                                                                                                                                                                                                                                |
| **Last commit**  | `feat(quant): Task 14.11 - audit fixes from GPT-5 + Gemini 2.5 reviews; params.json v2.0.0`                                                                                                                                                                                     |
| **Repo**         | https://github.com/frytegg/inflexion (private)                                                                                                                                                                                                                                  |
| **Quant track**  | 14.1–14.11 done (122 tests green). `quant/params.json` v2.0.0 (post-audit): c_min=7.25%, fund_target=$74k (CVaR), per_market_cap=700, per_mm_cap=140. Annualized ruin = 1.21% (was implicit). Cross-seed spread disclosed (c_min ±37bp, fund_target ±44%)                       |
| **Last update**  | 2026-05-27 — Audit fixes landed; params.json v2.0.0 regenerated                                                                                                                                                                                                                 |
