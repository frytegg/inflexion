...
| **▶ NEXT**       | Task **14.9** — deck charts (fund-P&L dist, ruin vs c, drawdown under 99.9th-pct correlated crash) → export to `apps/docs/static/quant/`                                                                                                                                        |
| **Spec version** | v3.3 build-ready                                                                                                                                                                                                                                                                |
| **Last commit**  | `feat(quant): Task 14.8 - versioned params.json + pydantic schema + CLI emitter (16 tests, 109 total)`                                                                                                                                                                          |
| **Repo**         | https://github.com/frytegg/inflexion (private)                                                                                                                                                                                                                                  |
| **Quant track**  | 14.1–14.8 done (109 tests green); next 14.9 (deck charts) → 14.10 (PR/milestone). `quant/params.json` v1.0.0 emitted: c_min=13.6%, fund_target=$24k, per_market_cap=100, per_mm_cap=20                                                                                          |
| **Last update**  | 2026-05-27 — Task 14.8 params.json + schema landed                                                                                                                                                                                                                              |
