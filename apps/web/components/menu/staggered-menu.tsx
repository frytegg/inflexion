...
// ReactBits StaggeredMenu — faithful port to TS. Recoloring lives in the CSS
// (staggered-menu.css, imported globally in app/layout.tsx) + the brand props
// passed at the call site. Behaviour/animation untouched.
