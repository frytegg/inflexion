...
*(Populated as packages land — see `CLAUDE.md` for current state.)*

## Demo-day playbook

*(Populated in Phase 12. Will cover: pre-seed, dry-run, fallback video, RPC pinning, gas pre-funding.)*
